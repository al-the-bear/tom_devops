...
import 'package:tom_basics/src/runtime/platform_environment_runtime.dart' as $tom_basics_1;
...
import 'package:tom_build_cli/src/tools/placeholder_resolver.dart' as $tom_build_cli_32;
import 'package:tom_build_cli/src/tools/tom_command_parser.dart' as $tom_build_cli_33;
import 'package:tom_build_cli/src/tools/tom_runner.dart' as $tom_build_cli_34;
import 'package:tom_build_cli/src/ws_prepper/template_parser.dart' as $tom_build_cli_35;
import 'package:tom_build_cli/src/ws_prepper/ws_prepper.dart' as $tom_build_cli_36;
...
class TomBuildCliBridge {
  ...
  static void registerGlobalVariables(D4rt interpreter, String importPath) {
    ...
    try {
      interpreter.registerGlobalVariable('knownCommands', $tom_build_cli_33.knownCommands, importPath, sourceUri: 'package:tom_build_cli/src/tools/tom_command_parser.dart');
    } catch (e) {
      errors.add('Failed to register variable "knownCommands": $e');
    }

    if (errors.isNotEmpty) {
      throw StateError('Bridge registration errors (tom_build_cli):\n${errors.join("\n")}');
    }
  }
  ...
  static Map<String, NativeFunctionImpl> globalFunctions() {
    return {
      ...
      'parseTomCommand': (visitor, positional, named, typeArgs) {
        ...
        return $tom_build_cli_33.parseTomCommand(args, additionalCommands: additionalCommands);
      },
      ...
      'runTomFromRepl': (visitor, positional, named, typeArgs) {
        if (!named.containsKey('args') || named['args'] == null) {
          throw ArgumentError('runTomFromRepl: Missing required named argument "args"');
        }
  ...
  static Map<String, String> globalFunctionSignatures() {
    return {
      ...
      'createD4rtEvaluatorFromContext': 'D4rtEvaluatorFunction createD4rtEvaluatorFromContext(ActionD4rtContext context)',
      'runTomCli': 'Future<int> runTomCli(List<String> args)',
      'parseBumpType': 'BumpType parseBumpType(String? value)',
      'discoverWorkspace': 'WorkspaceDiscoveryResult discoverWorkspace(String startPath)',
      'discoverProjects': 'Future<Map<String, TomProject>> discoverProjects(String workspacePath, TomWorkspace workspace)',
      'mergeStringLists': 'List<String> mergeStringLists(List<String>? base, List<String>? override)',
      'mergeDeps': 'Map<String, String> mergeDeps(Map<String, String>? base, Map<String, String>? override)',
      'createRealD4rtEvaluator': 'ActionD4rtEvaluator createRealD4rtEvaluator({Map<String, dynamic>? globalContext, BridgeConfiguration? bridgeConfiguration, TomWorkspace? workspace, WorkspaceContext? workspaceContext, TomProject? currentProject, String? workspacePath})',
      'createEvaluatorFromContext': 'ActionD4rtEvaluator createEvaluatorFromContext(ActionD4rtContext actionContext)',
      ...
      'determineExecutionMode': 'TomExecutionMode determineExecutionMode(List<String> args)',
      'runTomD4rt': 'Future<int> runTomD4rt(List<String> args)',
      'runTomFromRepl': 'Future<void> runTomFromRepl({required List<String> args, required String cwd})',
    };
  }
...
BridgedClass _createBridgeConfigurationBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final bridgeModules = named.containsKey('bridgeModules') && named['bridgeModules'] != null
            ...
            : const <String>[];
        final additionalClasses = named.containsKey('additionalClasses') && named['additionalClasses'] != null
            ? D4.coerceList<$tom_d4rt_1.BridgedClass>(named['additionalClasses'], 'additionalClasses')
            : const <$tom_d4rt_1.BridgedClass>[];
        final additionalClassImportPath = D4.getOptionalNamedArg<String?>(named, 'additionalClassImportPath');
        return $tom_build_cli_1.BridgeConfiguration(bridgeModules: bridgeModules, additionalClasses: additionalClasses, additionalClassImportPath: additionalClassImportPath);
      },
    },
    getters: {
      'bridgeModules': (visitor, target) => D4.validateTarget<$tom_build_cli_1.BridgeConfiguration>(target, 'BridgeConfiguration').bridgeModules,
      'additionalClasses': (visitor, target) => D4.validateTarget<$tom_build_cli_1.BridgeConfiguration>(target, 'BridgeConfiguration').additionalClasses,
      'additionalClassImportPath': (visitor, target) => D4.validateTarget<$tom_build_cli_1.BridgeConfiguration>(target, 'BridgeConfiguration').additionalClassImportPath,
    },
    methods: {
      'apply': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_1.BridgeConfiguration>(target, 'BridgeConfiguration');
        D4.requireMinArgs(positional, 1, 'apply');
        final interpreter = D4.getRequiredArg<$tom_d4rt_2.D4rt>(positional, 0, 'interpreter', 'apply');
        t.apply(interpreter);
        return null;
      },
      'withModules': (visitor, target, positional, named, typeArgs) {
        ...
        if (positional.isEmpty) {
          throw ArgumentError('withModules: Missing required argument "modules" at position 0');
        }
      ...
      'withClasses': (visitor, target, positional, named, typeArgs) {
        ...
        if (positional.isEmpty) {
          throw ArgumentError('withClasses: Missing required argument "classes" at position 0');
        }
        final classes = D4.coerceList<$tom_d4rt_1.BridgedClass>(positional[0], 'classes');
    ...
    methodSignatures: {
      ...
      'withClasses': 'BridgeConfiguration withClasses(List<BridgedClass> classes, {String? importPath})',
    },
    getterSignatures: {
  ...
  return BridgedClass(
    ...
    staticMethods: {
      'register': (visitor, positional, named, typeArgs) {
        ...
        final name = D4.getRequiredArg<String>(positional, 0, 'name', 'register');
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final projectName = D4.getRequiredNamedArg<String>(named, 'projectName', 'ActionContextProvider');
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        if (positional.isEmpty) {
          throw ArgumentError('StandaloneContextProvider: Missing required argument "customContext" at position 0');
        }
...
BridgedClass _createD4rtInstanceBridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      ...
      'create': 'factory D4rtInstance.create({BridgeConfiguration? bridgeConfiguration, TomWorkspace? workspace, WorkspaceContext? workspaceContext, TomProject? currentProject, String? workspacePath})',
      'fromProvider': 'factory D4rtInstance.fromProvider(D4rtContextProvider provider)',
    },
    methodSignatures: {
    ...
    staticGetterSignatures: {
      'current': 'D4rtInstance? get current',
    },
  );
}
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final projectName = D4.getRequiredNamedArg<String>(named, 'projectName', 'ActionD4rtContext');
        final actionName = D4.getRequiredNamedArg<String>(named, 'actionName', 'ActionD4rtContext');
        final additionalContext = named.containsKey('additionalContext') && named['additionalContext'] != null
            ? D4.coerceMap<String, dynamic>(named['additionalContext'], 'additionalContext')
            : const <String, dynamic>{};
        final bridgeConfiguration = D4.getOptionalNamedArg<$tom_build_cli_1.BridgeConfiguration?>(named, 'bridgeConfiguration');
...
BridgedClass _createParsedArgumentsBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final globalParameters = named.containsKey('globalParameters') && named['globalParameters'] != null
            ? D4.coerceMap<String, String>(named['globalParameters'], 'globalParameters')
            : const <String, String>{};
        final hasProjectsScope = D4.getNamedArgWithDefault<bool>(named, 'hasProjectsScope', false);
        final hasGroupsScope = D4.getNamedArgWithDefault<bool>(named, 'hasGroupsScope', false);
        final projects = named.containsKey('projects') && named['projects'] != null
            ? D4.coerceList<String>(named['projects'], 'projects')
            : const <String>[];
        final projectParameters = named.containsKey('projectParameters') && named['projectParameters'] != null
            ? D4.coerceMap<String, Map<String, String>>(named['projectParameters'], 'projectParameters')
            : const <String, Map<String, String>>{};
        final groups = named.containsKey('groups') && named['groups'] != null
            ? D4.coerceList<String>(named['groups'], 'groups')
            : const <String>[];
        final groupParameters = named.containsKey('groupParameters') && named['groupParameters'] != null
    ...
    getterSignatures: {
      ...
      'projectParameters': 'Map<String, Map<String, String>> get projectParameters',
...
BridgedClass _createArgumentParserBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'parse': 'ParsedArguments parse(List<String> args)',
    },
    staticGetterSignatures: {
...
BridgedClass _createGitHelperBridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      '': 'GitHelper({required String workspacePath})',
    },
    methodSignatures: {
      'isGitRepository': 'bool isGitRepository()',
      'getChangedFiles': 'Future<List<String>> getChangedFiles({String? since})',
      'getChangesSinceLastTag': 'Future<List<String>> getChangesSinceLastTag(String projectName)',
...
BridgedClass _createInternalCommandExecutorBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'execute': 'Future<InternalCommandResult> execute({required String commandName, Map<String, String> parameters = const {}})',
    },
    getterSignatures: {
      'config': 'InternalCommandConfig get config',
    },
  );
}
...
BridgedClass _createTomCliBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'run': 'Future<TomCliResult> run(List<String> args)',
    },
  );
}
...
BridgedClass _createVersionBumperBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'bumpVersion': 'Future<VersionBumpResult> bumpVersion(String projectPath, {required BumpType bumpType})',
    },
    getterSignatures: {
      'workspacePath': 'String get workspacePath',
      'dryRun': 'bool get dryRun',
...
BridgedClass _createVersionBumpResultBridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      ...
      'failure': 'factory VersionBumpResult.failure({required String projectPath, required String error})',
    },
    getterSignatures: {
...
BridgedClass _createWorkspaceDiscoveryResultBridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      ...
      'notFound': 'factory WorkspaceDiscoveryResult.notFound(String searchStart)',
    },
    getterSignatures: {
      'workspacePath': 'String? get workspacePath',
...
BridgedClass _createWorkspaceContextBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      ...
      'ensureMasterFilesGenerated': 'Future<MasterGenerationSummary> ensureMasterFilesGenerated()',
    ...
    staticGetterSignatures: {
      'current': 'WorkspaceContext? get current',
    },
  );
}
...
BridgedClass _createConfigLoaderBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'loadWorkspaceConfig': 'TomWorkspace? loadWorkspaceConfig(String workspaceDir)',
      'loadProjectConfig': 'TomProject? loadProjectConfig(String projectDir, String projectName)',
      'loadYamlFile': 'Map<String, dynamic> loadYamlFile(String filePath)',
      'loadWorkspaceWithImports': 'TomWorkspace? loadWorkspaceWithImports(String workspaceDir)',
    },
  );
}
  ...
  return BridgedClass(
    ...
    methods: {
      'deepMerge': (visitor, target, positional, named, typeArgs) {
        ...
        if (positional.length <= 1) {
          throw ArgumentError('deepMerge: Missing required argument "override" at position 1');
        }
        final override = D4.coerceMap<String, dynamic>(positional[1], 'override');
      ...
      'mergeAll': (visitor, target, positional, named, typeArgs) {
        ...
        final configs = D4.coerceList<Map<String, dynamic>>(positional[0], 'configs');
      ...
      'mergeProjectConfig': (visitor, target, positional, named, typeArgs) {
        ...
        final workspaceDefaults = D4.coerceMapOrNull<String, dynamic>(named['workspaceDefaults'], 'workspaceDefaults');
        final projectOverrides = D4.coerceMapOrNull<String, dynamic>(named['projectOverrides'], 'projectOverrides');
        final globalCliParams = D4.coerceMapOrNull<String, dynamic>(named['globalCliParams'], 'globalCliParams');
        final targetCliParams = D4.coerceMapOrNull<String, dynamic>(named['targetCliParams'], 'targetCliParams');
        return t.mergeProjectConfig(autoDetected: autoDetected, projectTypeDefaults: projectTypeDefaults, groupOverrides: groupOverrides, workspaceDefaults: workspaceDefaults, projectOverrides: projectOverrides, globalCliParams: globalCliParams, targetCliParams: targetCliParams);
      },
    },
    constructorSignatures: {
      '': 'ConfigMerger()',
    ...
    methodSignatures: {
      'deepMerge': 'Map<String, dynamic> deepMerge(Map<String, dynamic> base, Map<String, dynamic> override)',
      'mergeAll': 'Map<String, dynamic> mergeAll(List<Map<String, dynamic>> configs)',
      'mergeProjectConfig': 'Map<String, dynamic> mergeProjectConfig({Map<String, dynamic>? autoDetected, Map<String, dynamic>? projectTypeDefaults, Map<String, dynamic>? groupOverrides, Map<String, dynamic>? workspaceDefaults, Map<String, dynamic>? projectOverrides, Map<String, dynamic>? globalCliParams, Map<String, dynamic>? targetCliParams})',
    },
  );
}
...
BridgedClass _createValidationResultBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'formatErrors': 'String formatErrors()',
    },
    getterSignatures: {
...
BridgedClass _createConfigValidatorBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'validateWorkspace': 'ValidationResult validateWorkspace(TomWorkspace workspace, String filePath)',
      'validateProject': 'ValidationResult validateProject(TomProject project, String filePath)',
      'validateMaster': 'ValidationResult validateMaster(TomMaster master, String filePath)',
    },
  );
}
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'executeActionOnProjects': (visitor, target, positional, named, typeArgs) {
        ...
        final projectNames = D4.coerceList<String>(named['projectNames'], 'projectNames');
        final stopOnFailure = D4.getNamedArgWithDefault<bool>(named, 'stopOnFailure', true);
        return t.executeActionOnProjects(actionName: actionName, projectNames: projectNames, stopOnFailure: stopOnFailure);
      },
    },
    constructorSignatures: {
    ...
    methodSignatures: {
      'executeAction': 'Future<ActionExecutionResult> executeAction({required String actionName, required String projectName, Set<String>? additionalModes, Map<String, String>? parameters})',
      'executeActionOnProjects': 'Future<List<ActionExecutionResult>> executeActionOnProjects({required String actionName, required List<String> projectNames, bool stopOnFailure = true})',
    },
    getterSignatures: {
      'config': 'ActionExecutorConfig get config',
    },
  );
}
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'runAll': (visitor, target, positional, named, typeArgs) {
        ...
        final verbose = D4.getNamedArgWithDefault<bool>(named, 'verbose', false);
        final stopOnFailure = D4.getNamedArgWithDefault<bool>(named, 'stopOnFailure', true);
        return t.runAll(commands: commands, workingDirectory: workingDirectory, environment: environment, verbose: verbose, stopOnFailure: stopOnFailure);
      },
    },
    constructorSignatures: {
    ...
    methodSignatures: {
      'run': 'Future<CommandResult> run({required String command, String? workingDirectory, Map<String, String>? environment, bool verbose = false, Duration? timeout})',
      'runAll': 'Future<List<CommandResult>> runAll({required List<String> commands, String? workingDirectory, Map<String, String>? environment, bool verbose = false, bool stopOnFailure = true})',
    },
    getterSignatures: {
...
BridgedClass _createD4rtResultBridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      ...
      'failure': 'factory D4rtResult.failure({required String code, required String error, String output = \'\', Duration duration = Duration.zero})',
    },
    getterSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final scriptsPath = D4.getOptionalNamedArg<String?>(named, 'scriptsPath');
        final verbose = D4.getNamedArgWithDefault<bool>(named, 'verbose', false);
...
BridgedClass _createD4rtRunnerBridge() {
  return BridgedClass(
    ...
    getterSignatures: {
      'config': 'D4rtRunnerConfig get config',
    },
  );
}
  ...
  return BridgedClass(
    ...
    methods: {
      'copyWith': (visitor, target, positional, named, typeArgs) {
        ...
        return t.copyWith(useColors: useColors, verbose: verbose, showProgress: showProgress, showTimings: showTimings, maxWidth: maxWidth);
      },
    },
    constructorSignatures: {
    ...
    methodSignatures: {
      'copyWith': 'OutputFormatterConfig copyWith({bool? useColors, bool? verbose, bool? showProgress, bool? showTimings, int? maxWidth})',
    },
    getterSignatures: {
...
BridgedClass _createErrorMessageBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'format': 'String format({bool useColors = false})',
    },
    getterSignatures: {
      'description': 'String get description',
      'filePath': 'String? get filePath',
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'printPlaceholderRecursionError': (visitor, target, positional, named, typeArgs) {
        ...
        final unresolved = D4.coerceList<String>(named['unresolved'], 'unresolved');
        t.printPlaceholderRecursionError(filePath: filePath, unresolved: unresolved);
        return null;
      },
      ...
      'formatHelp': (visitor, target, positional, named, typeArgs) {
        ...
        if (!named.containsKey('usage') || named['usage'] == null) {
          throw ArgumentError('formatHelp: Missing required named argument "usage"');
        }
        final usage = D4.coerceList<String>(named['usage'], 'usage');
        if (!named.containsKey('commands') || named['commands'] == null) {
          throw ArgumentError('formatHelp: Missing required named argument "commands"');
        }
        final commands = D4.coerceMap<String, String>(named['commands'], 'commands');
        if (!named.containsKey('options') || named['options'] == null) {
          throw ArgumentError('formatHelp: Missing required named argument "options"');
        }
        final options = D4.coerceMap<String, String>(named['options'], 'options');
        return t.formatHelp(toolName: toolName, version: version, description: description, usage: usage, commands: commands, options: options);
      },
    },
    constructorSignatures: {
    ...
    methodSignatures: {
      ...
      'printCircularDependencyError': 'void printCircularDependencyError(List<String> cycle)',
      'printPlaceholderRecursionError': 'void printPlaceholderRecursionError({required String filePath, required List<String> unresolved})',
      ...
      'createProgress': 'ProgressIndicator createProgress(String message, int total)',
      'printHeader': 'void printHeader(String title)',
      'formatCommandResult': 'String formatCommandResult(CommandResult result)',
      'formatActionResult': 'String formatActionResult(ActionExecutionResult result)',
      'formatInternalCommandResult': 'String formatInternalCommandResult(InternalCommandResult result)',
      'formatSummary': 'String formatSummary({required List<ActionExecutionResult> actionResults, required List<InternalCommandResult> commandResults, required Duration totalDuration})',
      'printSummary': 'void printSummary({required List<ActionExecutionResult> actionResults, required List<InternalCommandResult> commandResults, required Duration totalDuration})',
      'formatHelp': 'String formatHelp({required String toolName, required String version, required String description, required List<String> usage, required Map<String, String> commands, required Map<String, String> options})',
    },
    getterSignatures: {
      'useColors': 'bool get useColors',
    },
...
BridgedClass _createBuildOrderResultBridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      ...
      'error': 'factory BuildOrderResult.error(String message, {List<String>? circularPath})',
    },
    getterSignatures: {
...
BridgedClass _createBuildOrderCalculatorBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'calculateBuildOrder': 'List<String> calculateBuildOrder(Map<String, BuildOrderProject> projects)',
      'calculateBuildOrderSafe': 'BuildOrderResult calculateBuildOrderSafe(Map<String, BuildOrderProject> projects)',
      'calculateActionOrder': 'List<String> calculateActionOrder({required Map<String, BuildOrderProject> projects, required String action, Map<String, List<String>>? actionDeps})',
      'validateDependencies': 'List<String> validateDependencies(Map<String, BuildOrderProject> projects)',
    },
    staticMethodSignatures: {
      'fromProjectConfigs': 'Map<String, BuildOrderProject> fromProjectConfigs(Map<String, Map<String, dynamic>> configs)',
    },
  );
}
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final fullyResolved = D4.getRequiredNamedArg<bool>(named, 'fullyResolved', 'GeneratorResult');
  ...
  return BridgedClass(
    ...
    methods: {
      'resolve': (visitor, target, positional, named, typeArgs) {
        ...
        final context = D4.coerceMap<String, dynamic>(named['context'], 'context');
        final throwOnUnresolved = D4.getNamedArgWithDefault<bool>(named, 'throwOnUnresolved', true);
        return t.resolve(content: content, context: context, throwOnUnresolved: throwOnUnresolved);
      },
    },
    constructorSignatures: {
    ...
    methodSignatures: {
      'resolve': 'GeneratorResult resolve({required dynamic content, required Map<String, dynamic> context, bool throwOnUnresolved = true})',
    },
  );
}
  ...
  return BridgedClass(
    ...
    constructors: {
      'success': (visitor, positional, named) {
        ...
        if (positional.isEmpty) {
          throw ArgumentError('MasterGenerationResult: Missing required argument "data" at position 0');
        }
...
BridgedClass _createMasterGeneratorBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      ...
      'generateAndWriteMaster': 'MasterGenerationResult generateAndWriteMaster()',
      'generateAndWriteActionMaster': 'MasterGenerationResult generateAndWriteActionMaster(String action)',
      'generateAndWriteAllActionMasters': 'List<MasterGenerationResult> generateAndWriteAllActionMasters()',
    },
    getterSignatures: {
      'workspace': 'TomWorkspace get workspace',
      'projects': 'Map<String, TomProject> get projects',
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final fullyResolved = D4.getRequiredNamedArg<bool>(named, 'fullyResolved', 'PlaceholderResult');
        final unresolvedPlaceholders = named.containsKey('unresolvedPlaceholders') && named['unresolvedPlaceholders'] != null
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        if (!named.containsKey('unresolvedPlaceholders') || named['unresolvedPlaceholders'] == null) {
          throw ArgumentError('GeneratorPlaceholderException: Missing required named argument "unresolvedPlaceholders"');
        }
...
BridgedClass _createPlaceholderResolverBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      'resolve': 'PlaceholderResult resolve({required dynamic content, required Map<String, dynamic> context, bool throwOnUnresolved = true})',
    },
    staticGetterSignatures: {
      'maxIterations': 'int get maxIterations',
    },
  );
}
...
BridgedClass _createModeProcessorBridge() {
  return BridgedClass(
    ...
    methods: {
      'processContent': (visitor, target, positional, named, typeArgs) {
        ...
        final modeTypeValues = named.containsKey('modeTypeValues') && named['modeTypeValues'] != null
            ...
            : const <String, String>{};
        return t.processContent(content, activeModes, modeTypeValues: modeTypeValues);
      },
    },
    constructorSignatures: {
      '': 'ModeProcessor()',
    ...
    methodSignatures: {
      'processContent': 'String processContent(String content, Set<String> activeModes, {Map<String, String> modeTypeValues = const {}})',
    },
  );
}
  ...
  return BridgedClass(
    ...
    methods: {
      'resolve': (visitor, target, positional, named, typeArgs) {
        ...
        final cliOverrides = named.containsKey('cliOverrides') && named['cliOverrides'] != null
            ? D4.coerceMap<String, String>(named['cliOverrides'], 'cliOverrides')
            : const <String, String>{};
    ...
    methodSignatures: {
      'resolve': 'ResolvedModes resolve({required String actionName, WorkspaceModes? workspaceModes, Map<String, ModeDefinitions>? modeDefinitions, Map<String, String> cliOverrides = const {}})',
      'resolveModeProperties': 'Map<String, dynamic> resolveModeProperties({required ResolvedModes resolved, required Map<String, ModeDefinitions>? modeDefinitions})',
      'getDefaultMode': 'String? getDefaultMode(String modeType, WorkspaceModes? workspaceModes)',
    },
  );
}
...
BridgedClass _createTomplateParserBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      ...
      'parseContent': 'TomplateFile parseContent(String content, String sourcePath)',
    },
  );
}
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final targetPath = D4.getRequiredNamedArg<String>(named, 'targetPath', 'TomplateFile');
        final content = D4.getRequiredNamedArg<String>(named, 'content', 'TomplateFile');
    ...
    methodSignatures: {
      'getPlaceholdersOfType': 'List<PlaceholderInfo> getPlaceholdersOfType(PlaceholderType type)',
    },
    getterSignatures: {
  ...
  return BridgedClass(
    ...
    methods: {
      'process': (visitor, target, positional, named, typeArgs) {
        ...
        final environment = D4.coerceMapOrNull<String, String>(named['environment'], 'environment');
        final resolveGenerators = D4.getNamedArgWithDefault<bool>(named, 'resolveGenerators', true);
      ...
      'processAndWrite': (visitor, target, positional, named, typeArgs) {
        ...
        final resolveEnvironment = D4.getNamedArgWithDefault<bool>(named, 'resolveEnvironment', false);
        final environment = D4.coerceMapOrNull<String, String>(named['environment'], 'environment');
        t.processAndWrite(template: template, resolvedModes: resolvedModes, context: context, resolveEnvironment: resolveEnvironment, environment: environment);
        return null;
      },
    },
    constructorSignatures: {
    ...
    methodSignatures: {
      'process': 'TomplateResult process({required TomplateFile template, ResolvedModes? resolvedModes, Map<String, dynamic>? context, bool resolveEnvironment = false, Map<String, String>? environment, bool resolveGenerators = true})',
      'writeToFile': 'void writeToFile(TomplateResult processed)',
      'processAndWrite': 'void processAndWrite({required TomplateFile template, ResolvedModes? resolvedModes, Map<String, dynamic>? context, bool resolveEnvironment = false, Map<String, String>? environment})',
    },
  );
}
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final prefix = D4.getRequiredArg<String>(positional, 0, 'prefix', 'CliArgs');
        if (positional.length <= 1) {
    ...
    getters: {
      'prefix': (visitor, target) => D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs').prefix,
      'rawArgs': (visitor, target) => D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs').rawArgs,
      'positionalArgs': (visitor, target) => D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs').positionalArgs,
      'namedParams': (visitor, target) => D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs').namedParams,
      'flags': (visitor, target) => D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs').flags,
      'help': (visitor, target) => D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs').help,
      'dryRun': (visitor, target) => D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs').dryRun,
      'verbose': (visitor, target) => D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs').verbose,
    },
    methods: {
      'get': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_30.CliArgs>(target, 'CliArgs');
        D4.requireMinArgs(positional, 1, 'get');
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final commands = D4.coerceList<String>(named['commands'], 'commands');
        return $tom_build_cli_31.PipelineDefinition(name: name, commands: commands);
      },
    ...
    getters: {
      'name': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineDefinition>(target, 'PipelineDefinition').name,
      'commands': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineDefinition>(target, 'PipelineDefinition').commands,
    },
    methods: {
      'parseCommands': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_31.PipelineDefinition>(target, 'PipelineDefinition');
    ...
    constructorSignatures: {
      ...
      'fromYaml': 'factory PipelineDefinition.fromYaml(String name, dynamic yaml)',
    },
    methodSignatures: {
...
BridgedClass _createPipelineResultBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final pipeline = D4.getRequiredNamedArg<$tom_build_cli_31.PipelineDefinition>(named, 'pipeline', 'PipelineResult');
        if (!named.containsKey('commandResults') || named['commandResults'] == null) {
          throw ArgumentError('PipelineResult: Missing required named argument "commandResults"');
        }
        final commandResults = D4.coerceList<$tom_build_cli_34.TomRunResults>(named['commandResults'], 'commandResults');
        return $tom_build_cli_31.PipelineResult(pipeline: pipeline, commandResults: commandResults);
      },
    },
    getters: {
      'pipeline': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineResult>(target, 'PipelineResult').pipeline,
      'commandResults': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineResult>(target, 'PipelineResult').commandResults,
      'success': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineResult>(target, 'PipelineResult').success,
      'totalDuration': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineResult>(target, 'PipelineResult').totalDuration,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_31.PipelineResult>(target, 'PipelineResult');
        return t.toString();
      },
    },
    constructorSignatures: {
...
BridgedClass _createPipelineLoaderBridge() {
  return BridgedClass(
    ...
    getters: {
      'workspacePath': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineLoader>(target, 'PipelineLoader').workspacePath,
    },
    methods: {
      'loadPipelines': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_31.PipelineLoader>(target, 'PipelineLoader');
    ...
    constructorSignatures: {
      '': 'PipelineLoader(String workspacePath)',
    },
    methodSignatures: {
      'loadPipelines': 'Future<Map<String, PipelineDefinition>> loadPipelines()',
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final dryRun = D4.getNamedArgWithDefault<bool>(named, 'dryRun', false);
        final output = D4.getOptionalNamedArg<StringSink?>(named, 'output');
        return $tom_build_cli_31.PipelineRunner(workspacePath: workspacePath, verbose: verbose, dryRun: dryRun, output: output);
      },
    },
    getters: {
      'workspacePath': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineRunner>(target, 'PipelineRunner').workspacePath,
      'verbose': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineRunner>(target, 'PipelineRunner').verbose,
      'dryRun': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineRunner>(target, 'PipelineRunner').dryRun,
      'output': (visitor, target) => D4.validateTarget<$tom_build_cli_31.PipelineRunner>(target, 'PipelineRunner').output,
    },
    methods: {
      'runPipeline': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_31.PipelineRunner>(target, 'PipelineRunner');
      ...
      'execute': (visitor, target, positional, named, typeArgs) {
        ...
        final pipeline = D4.getRequiredArg<$tom_build_cli_31.PipelineDefinition>(positional, 0, 'pipeline', 'execute');
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final publishable = D4.getNamedArgWithDefault<bool>(named, 'publishable', true);
        final lastChangeCommit = D4.getOptionalNamedArg<String?>(named, 'lastChangeCommit');
        final metadata = named.containsKey('metadata') && named['metadata'] != null
            ? D4.coerceMap<String, dynamic>(named['metadata'], 'metadata')
            : const <String, dynamic>{};
        return $tom_build_cli_32.PackageInfo(name: name, version: version, publishable: publishable, lastChangeCommit: lastChangeCommit, metadata: metadata);
      },
      'fromYaml': (visitor, positional, named) {
    ...
    getters: {
      'name': (visitor, target) => D4.validateTarget<$tom_build_cli_32.PackageInfo>(target, 'PackageInfo').name,
      'version': (visitor, target) => D4.validateTarget<$tom_build_cli_32.PackageInfo>(target, 'PackageInfo').version,
      'publishable': (visitor, target) => D4.validateTarget<$tom_build_cli_32.PackageInfo>(target, 'PackageInfo').publishable,
      'lastChangeCommit': (visitor, target) => D4.validateTarget<$tom_build_cli_32.PackageInfo>(target, 'PackageInfo').lastChangeCommit,
      'metadata': (visitor, target) => D4.validateTarget<$tom_build_cli_32.PackageInfo>(target, 'PackageInfo').metadata,
    },
    methods: {
      'toMap': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_32.PackageInfo>(target, 'PackageInfo');
        return t.toMap();
      },
      '[]': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_32.PackageInfo>(target, 'PackageInfo');
...
BridgedClass _createTomPlaceholderResolverBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        if (!named.containsKey('data') || named['data'] == null) {
          throw ArgumentError('TomPlaceholderResolver: Missing required named argument "data"');
        }
        ...
        return $tom_build_cli_32.TomPlaceholderResolver(data: data, environment: environment, d4rt: d4rt);
      },
    },
    getters: {
      'data': (visitor, target) => D4.validateTarget<$tom_build_cli_32.TomPlaceholderResolver>(target, 'TomPlaceholderResolver').data,
      'environment': (visitor, target) => D4.validateTarget<$tom_build_cli_32.TomPlaceholderResolver>(target, 'TomPlaceholderResolver').environment,
      'd4rt': (visitor, target) => D4.validateTarget<$tom_build_cli_32.TomPlaceholderResolver>(target, 'TomPlaceholderResolver').d4rt,
    },
    methods: {
      'resolve': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_32.TomPlaceholderResolver>(target, 'TomPlaceholderResolver');
    ...
    methodSignatures: {
      'resolve': 'Future<String> resolve(String input)',
    },
    getterSignatures: {
      'data': 'Map<String, dynamic> get data',
      'environment': 'Map<String, String> get environment',
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final positionalArgs = named.containsKey('positionalArgs') && named['positionalArgs'] != null
            ...
            : const <String>[];
        return $tom_build_cli_33.ParsedCommand(name: name, params: params, flags: flags, positionalArgs: positionalArgs);
      },
    },
    getters: {
      'name': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedCommand>(target, 'ParsedCommand').name,
      'params': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedCommand>(target, 'ParsedCommand').params,
      'flags': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedCommand>(target, 'ParsedCommand').flags,
      'positionalArgs': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedCommand>(target, 'ParsedCommand').positionalArgs,
      'verbose': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedCommand>(target, 'ParsedCommand').verbose,
      'dryRun': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedCommand>(target, 'ParsedCommand').dryRun,
      'help': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedCommand>(target, 'ParsedCommand').help,
    },
    methods: {
      'get': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_33.ParsedCommand>(target, 'ParsedCommand');
        D4.requireMinArgs(positional, 1, 'get');
        final key = D4.getRequiredArg<String>(positional, 0, 'key', 'get');
        final defaultValue = D4.getOptionalArgWithDefault<String>(positional, 1, 'defaultValue', '');
        return t.get(key, defaultValue);
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final commands = D4.coerceList<$tom_build_cli_33.ParsedCommand>(named['commands'], 'commands');
        ...
        return $tom_build_cli_33.ParsedTomCommand(globalParams: globalParams, globalFlags: globalFlags, commands: commands, rawArgs: rawArgs);
      },
    },
    getters: {
      'globalParams': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand').globalParams,
      'globalFlags': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand').globalFlags,
      'commands': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand').commands,
      'rawArgs': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand').rawArgs,
      'verbose': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand').verbose,
      'dryRun': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand').dryRun,
      'help': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand').help,
      'hasCommands': (visitor, target) => D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand').hasCommands,
    },
    methods: {
      'get': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_33.ParsedTomCommand>(target, 'ParsedTomCommand');
        D4.requireMinArgs(positional, 1, 'get');
        final key = D4.getRequiredArg<String>(positional, 0, 'key', 'get');
        final defaultValue = D4.getOptionalArgWithDefault<String>(positional, 1, 'defaultValue', '');
        return t.get(key, defaultValue);
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return $tom_build_cli_33.TomCommandParser(additionalCommands: additionalCommands);
      },
    },
    getters: {
      'additionalCommands': (visitor, target) => D4.validateTarget<$tom_build_cli_33.TomCommandParser>(target, 'TomCommandParser').additionalCommands,
      'allCommands': (visitor, target) => D4.validateTarget<$tom_build_cli_33.TomCommandParser>(target, 'TomCommandParser').allCommands,
    },
    methods: {
      'parse': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_33.TomCommandParser>(target, 'TomCommandParser');
        D4.requireMinArgs(positional, 1, 'parse');
        if (positional.isEmpty) {
          throw ArgumentError('parse: Missing required argument "args" at position 0');
        }
      ...
      'mergeWithGlobals': (visitor, target, positional, named, typeArgs) {
        ...
        final cmd = D4.getRequiredArg<$tom_build_cli_33.ParsedCommand>(positional, 0, 'cmd', 'mergeWithGlobals');
        if (positional.length <= 1) {
    ...
    methodSignatures: {
      ...
      'mergeWithGlobals': 'ParsedCommand mergeWithGlobals(ParsedCommand cmd, Map<String, String> globalParams, Set<String> globalFlags)',
    },
    getterSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final command = D4.getRequiredNamedArg<String>(named, 'command', 'TomRunResult');
        ...
        return $tom_build_cli_34.TomRunResult(success: success, command: command, message: message, error: error, duration: duration);
      },
    },
    getters: {
      'success': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunResult>(target, 'TomRunResult').success,
      'command': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunResult>(target, 'TomRunResult').command,
      'message': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunResult>(target, 'TomRunResult').message,
      'error': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunResult>(target, 'TomRunResult').error,
      'duration': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunResult>(target, 'TomRunResult').duration,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_34.TomRunResult>(target, 'TomRunResult');
        return t.toString();
      },
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final results = D4.coerceList<$tom_build_cli_34.TomRunResult>(positional[0], 'results');
        return $tom_build_cli_34.TomRunResults(results);
      },
    },
    getters: {
      'results': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunResults>(target, 'TomRunResults').results,
      'success': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunResults>(target, 'TomRunResults').success,
      'totalDuration': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunResults>(target, 'TomRunResults').totalDuration,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_34.TomRunResults>(target, 'TomRunResults');
        return t.toString();
      },
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final dryRun = D4.getNamedArgWithDefault<bool>(named, 'dryRun', false);
        final output = D4.getOptionalNamedArg<StringSink?>(named, 'output');
        return $tom_build_cli_34.TomRunner(workspacePath: workspacePath, verbose: verbose, dryRun: dryRun, output: output);
      },
    },
    getters: {
      'workspacePath': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunner>(target, 'TomRunner').workspacePath,
      'verbose': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunner>(target, 'TomRunner').verbose,
      'dryRun': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunner>(target, 'TomRunner').dryRun,
      'output': (visitor, target) => D4.validateTarget<$tom_build_cli_34.TomRunner>(target, 'TomRunner').output,
    },
    methods: {
      'run': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_34.TomRunner>(target, 'TomRunner');
        D4.requireMinArgs(positional, 1, 'run');
        final parsed = D4.getRequiredArg<$tom_build_cli_33.ParsedTomCommand>(positional, 0, 'parsed', 'run');
        return t.run(parsed);
      },
    },
    constructorSignatures: {
...
BridgedClass _createTemplateParserBridge() {
  return BridgedClass(
    ...
    getters: {
      'content': (visitor, target) => D4.validateTarget<$tom_build_cli_35.TemplateParser>(target, 'TemplateParser').content,
    },
    methods: {
      'parse': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_35.TemplateParser>(target, 'TemplateParser');
        return t.parse();
      },
    },
    staticGetters: {
      'markerPrefix': (visitor) => $tom_build_cli_35.TemplateParser.markerPrefix,
      'modeStartPattern': (visitor) => $tom_build_cli_35.TemplateParser.modeStartPattern,
      'modeEndPattern': (visitor) => $tom_build_cli_35.TemplateParser.modeEndPattern,
    },
    constructorSignatures: {
      '': 'TemplateParser(String content)',
    },
    methodSignatures: {
      'parse': 'ParsedTemplate parse()',
    },
    getterSignatures: {
      'content': 'String get content',
    },
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final segments = D4.coerceList<$tom_build_cli_35.TemplateSegment>(named['segments'], 'segments');
        if (!named.containsKey('blocks') || named['blocks'] == null) {
          throw ArgumentError('ParsedTemplate: Missing required named argument "blocks"');
        }
        final blocks = D4.coerceList<$tom_build_cli_35.ModeBlock>(named['blocks'], 'blocks');
        return $tom_build_cli_35.ParsedTemplate(segments: segments, blocks: blocks);
      },
    },
    getters: {
      'segments': (visitor, target) => D4.validateTarget<$tom_build_cli_35.ParsedTemplate>(target, 'ParsedTemplate').segments,
      'blocks': (visitor, target) => D4.validateTarget<$tom_build_cli_35.ParsedTemplate>(target, 'ParsedTemplate').blocks,
      'definedModes': (visitor, target) => D4.validateTarget<$tom_build_cli_35.ParsedTemplate>(target, 'ParsedTemplate').definedModes,
    },
    constructorSignatures: {
...
BridgedClass _createTextSegmentBridge() {
  return BridgedClass(
    ...
    getters: {
      'content': (visitor, target) => D4.validateTarget<$tom_build_cli_35.TextSegment>(target, 'TextSegment').content,
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final blocks = D4.coerceList<$tom_build_cli_35.ModeBlock>(positional[0], 'blocks');
        return $tom_build_cli_35.ModeBlockGroup(blocks);
      },
    },
    getters: {
      'blocks': (visitor, target) => D4.validateTarget<$tom_build_cli_35.ModeBlockGroup>(target, 'ModeBlockGroup').blocks,
    },
    constructorSignatures: {
...
BridgedClass _createModeBlockBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        if (!named.containsKey('modes') || named['modes'] == null) {
          throw ArgumentError('ModeBlock: Missing required named argument "modes"');
        }
    ...
    getters: {
      'modes': (visitor, target) => D4.validateTarget<$tom_build_cli_35.ModeBlock>(target, 'ModeBlock').modes,
      'content': (visitor, target) => D4.validateTarget<$tom_build_cli_35.ModeBlock>(target, 'ModeBlock').content,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_35.ModeBlock>(target, 'ModeBlock');
        return t.toString();
      },
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final options = D4.getOptionalNamedArg<$tom_build_cli_36.WsPrepperOptions?>(named, 'options');
        return $tom_build_cli_36.WsPrepper(workspacePath, options: options);
      },
    },
    getters: {
      'workspacePath': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepper>(target, 'WsPrepper').workspacePath,
      'options': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepper>(target, 'WsPrepper').options,
    },
    methods: {
      'findTemplates': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_36.WsPrepper>(target, 'WsPrepper');
      ...
      'generateOutput': (visitor, target, positional, named, typeArgs) {
        ...
        final parsed = D4.getRequiredArg<$tom_build_cli_35.ParsedTemplate>(positional, 0, 'parsed', 'generateOutput');
    ...
    methodSignatures: {
      ...
      'processTemplate': 'Future<PreparedTemplate> processTemplate(File template, String mode)',
      'generateOutput': 'String generateOutput(ParsedTemplate parsed, String mode)',
    },
    getterSignatures: {
      'workspacePath': 'String get workspacePath',
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return $tom_build_cli_36.WsPrepperOptions(dryRun: dryRun, excludePatterns: excludePatterns);
      },
    },
    getters: {
      'dryRun': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperOptions>(target, 'WsPrepperOptions').dryRun,
      'excludePatterns': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperOptions>(target, 'WsPrepperOptions').excludePatterns,
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final processed = D4.coerceListOrNull<$tom_build_cli_36.PreparedTemplate>(named['processed'], 'processed');
        final errors = D4.coerceListOrNull<$tom_build_cli_36.WsPrepperError>(named['errors'], 'errors');
        return $tom_build_cli_36.WsPrepperResult(mode: mode, processed: processed, errors: errors);
      },
    },
    getters: {
      'mode': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperResult>(target, 'WsPrepperResult').mode,
      'processed': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperResult>(target, 'WsPrepperResult').processed,
      'errors': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperResult>(target, 'WsPrepperResult').errors,
      'success': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperResult>(target, 'WsPrepperResult').success,
      'totalTemplates': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperResult>(target, 'WsPrepperResult').totalTemplates,
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final outputPath = D4.getRequiredNamedArg<String>(named, 'outputPath', 'PreparedTemplate');
        ...
        final dryRun = D4.getNamedArgWithDefault<bool>(named, 'dryRun', false);
        return $tom_build_cli_36.PreparedTemplate(templatePath: templatePath, outputPath: outputPath, mode: mode, blocksFound: blocksFound, dryRun: dryRun);
      },
    },
    getters: {
      'templatePath': (visitor, target) => D4.validateTarget<$tom_build_cli_36.PreparedTemplate>(target, 'PreparedTemplate').templatePath,
      'outputPath': (visitor, target) => D4.validateTarget<$tom_build_cli_36.PreparedTemplate>(target, 'PreparedTemplate').outputPath,
      'mode': (visitor, target) => D4.validateTarget<$tom_build_cli_36.PreparedTemplate>(target, 'PreparedTemplate').mode,
      'blocksFound': (visitor, target) => D4.validateTarget<$tom_build_cli_36.PreparedTemplate>(target, 'PreparedTemplate').blocksFound,
      'dryRun': (visitor, target) => D4.validateTarget<$tom_build_cli_36.PreparedTemplate>(target, 'PreparedTemplate').dryRun,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_36.PreparedTemplate>(target, 'PreparedTemplate');
        return t.toString();
      },
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return $tom_build_cli_36.WsPrepperError(templatePath: templatePath, message: message);
      },
    },
    getters: {
      'templatePath': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperError>(target, 'WsPrepperError').templatePath,
      'message': (visitor, target) => D4.validateTarget<$tom_build_cli_36.WsPrepperError>(target, 'WsPrepperError').message,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_cli_36.WsPrepperError>(target, 'WsPrepperError');
        return t.toString();
      },
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'handleAdditionalCommands': (visitor, target, positional, named, typeArgs) {
        ...
        final line = D4.getRequiredArg<String>(positional, 2, 'line', 'handleAdditionalCommands');
      ...
      'handleAdditionalMultilineEnd': (visitor, target, positional, named, typeArgs) {
        ...
        final mode = D4.getRequiredArg<$tom_d4rt_dcli_1.MultilineMode>(positional, 2, 'mode', 'handleAdditionalMultilineEnd');
        final code = D4.getRequiredArg<String>(positional, 3, 'code', 'handleAdditionalMultilineEnd');
        final silent = D4.getNamedArgWithDefault<bool>(named, 'silent', false);
      ...
      'processInput': (visitor, target, positional, named, typeArgs) {
        ...
        final input = D4.getRequiredArg<String>(positional, 2, 'input', 'processInput');
        final silent = D4.getNamedArgWithDefault<bool>(named, 'silent', false);
      ...
      'handleVSCodeMultilineEnd': (visitor, target, positional, named, typeArgs) {
        ...
        final code = D4.getRequiredArg<String>(positional, 2, 'code', 'handleVSCodeMultilineEnd');
        final silent = D4.getNamedArgWithDefault<bool>(named, 'silent', false);
        return t.handleVSCodeMultilineEnd(state, mode, code, silent: silent);
      },
    },
    constructorSignatures: {
      '': 'TomD4rtRepl()',
    ...
    methodSignatures: {
      ...
      'handleAdditionalCommands': 'Future<bool> handleAdditionalCommands(D4rt d4rt, ReplState state, String line, {bool silent = false})',
      ...
      'handleAdditionalMultilineEnd': 'Future<bool> handleAdditionalMultilineEnd(D4rt d4rt, ReplState state, MultilineMode mode, String code, {bool silent = false})',
      ...
      'processInput': 'Future<bool> processInput(D4rt d4rt, ReplState state, String input, {bool silent = false})',
      'getPackageNames': 'List<String> getPackageNames(D4rt d4rt)',
      'printAllPackagesInfo': 'void printAllPackagesInfo(D4rt d4rt)',
      'initVSCodeIntegration': 'void initVSCodeIntegration({void Function(String)? onStatusMessage, void Function(String)? onErrorMessage})',
      'checkVSCodeAvailability': 'Future<void> checkVSCodeAvailability()',
      'getVSCodeIntegrationHelp': 'String getVSCodeIntegrationHelp()',
      'handleVSCodeCommands': 'Future<bool> handleVSCodeCommands(ReplState state, String line, {bool silent = false})',
      'handleVSCodeMultilineEnd': 'Future<bool> handleVSCodeMultilineEnd(ReplState state, MultilineMode mode, String code, {bool silent = false})',
    },
    getterSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final workspaceModes = D4.getOptionalNamedArg<$tom_build_1.WorkspaceModes?>(named, 'workspaceModes');
        final crossCompilation = D4.getOptionalNamedArg<$tom_build_1.CrossCompilation?>(named, 'crossCompilation');
        final groups = named.containsKey('groups') && named['groups'] != null
            ? D4.coerceMap<String, $tom_build_1.GroupDef>(named['groups'], 'groups')
            : const <String, $tom_build_1.GroupDef>{};
        final projectTypes = named.containsKey('projectTypes') && named['projectTypes'] != null
            ? D4.coerceMap<String, $tom_build_1.ProjectTypeDef>(named['projectTypes'], 'projectTypes')
            : const <String, $tom_build_1.ProjectTypeDef>{};
        final actions = named.containsKey('actions') && named['actions'] != null
            ? D4.coerceMap<String, $tom_build_1.ActionDef>(named['actions'], 'actions')
            : const <String, $tom_build_1.ActionDef>{};
        final modeDefinitions = named.containsKey('modeDefinitions') && named['modeDefinitions'] != null
            ? D4.coerceMap<String, $tom_build_1.ModeDefinitions>(named['modeDefinitions'], 'modeDefinitions')
            : const <String, $tom_build_1.ModeDefinitions>{};
        final pipelines = named.containsKey('pipelines') && named['pipelines'] != null
            ? D4.coerceMap<String, $tom_build_1.Pipeline>(named['pipelines'], 'pipelines')
            : const <String, $tom_build_1.Pipeline>{};
        final projectInfo = named.containsKey('projectInfo') && named['projectInfo'] != null
            ? D4.coerceMap<String, $tom_build_1.ProjectEntry>(named['projectInfo'], 'projectInfo')
        ...
        final depsDev = named.containsKey('depsDev') && named['depsDev'] != null
            ...
            : const <String, String>{};
        final versionSettings = D4.getOptionalNamedArg<$tom_build_1.VersionSettings?>(named, 'versionSettings');
    ...
    getters: {
      'name': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').name,
      'binaries': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').binaries,
      'operatingSystems': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').operatingSystems,
      'mobilePlatforms': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').mobilePlatforms,
      'imports': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').imports,
      'workspaceModes': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').workspaceModes,
      'crossCompilation': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').crossCompilation,
      'groups': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').groups,
      'projectTypes': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').projectTypes,
      'actions': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').actions,
      'modeDefinitions': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').modeDefinitions,
      'pipelines': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').pipelines,
      'projectInfo': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').projectInfo,
      'deps': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').deps,
      'depsDev': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').depsDev,
      'versionSettings': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').versionSettings,
      'customTags': (visitor, target) => D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace').customTags,
    },
    methods: {
      'toYaml': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_1.TomWorkspace>(target, 'TomWorkspace');
        return t.toYaml();
      },
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final features = D4.getOptionalNamedArg<$tom_build_1.Features?>(named, 'features');
        final actions = named.containsKey('actions') && named['actions'] != null
            ? D4.coerceMap<String, $tom_build_1.ActionDef>(named['actions'], 'actions')
            : const <String, $tom_build_1.ActionDef>{};
        final modeDefinitions = named.containsKey('modeDefinitions') && named['modeDefinitions'] != null
            ...
            : const <String, $tom_build_1.ModeDefinitions>{};
        final crossCompilation = D4.getOptionalNamedArg<$tom_build_1.CrossCompilation?>(named, 'crossCompilation');
        final packageModule = D4.getOptionalNamedArg<$tom_build_1.PackageModule?>(named, 'packageModule');
        ...
        final executables = named.containsKey('executables') && named['executables'] != null
            ? D4.coerceList<$tom_build_1.ExecutableDef>(named['executables'], 'executables')
      ...
      'fromYaml': (visitor, positional, named) {
        ...
        final defaultActions = D4.coerceMapOrNull<String, $tom_build_1.ActionDef>(named['defaultActions'], 'defaultActions');
        return $tom_build_1.TomProject.fromYaml(name, yaml, defaultActions: defaultActions);
      },
    },
    getters: {
      'name': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').name,
      'type': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').type,
      'description': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').description,
      'binaries': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').binaries,
      'buildAfter': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').buildAfter,
      'actionOrder': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').actionOrder,
      'features': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').features,
      'actions': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').actions,
      'modeDefinitions': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').modeDefinitions,
      'crossCompilation': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').crossCompilation,
      'packageModule': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').packageModule,
      'parts': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').parts,
      'tests': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').tests,
      'examples': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').examples,
      'docs': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').docs,
      'copilotGuidelines': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').copilotGuidelines,
      'binaryFiles': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').binaryFiles,
      'executables': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').executables,
      'metadataFiles': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').metadataFiles,
      'actionModeDefinitions': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').actionModeDefinitions,
      'customTags': (visitor, target) => D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject').customTags,
    },
    methods: {
      'toYaml': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject');
        return t.toYaml();
      },
      'toYamlCompact': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_build_1.TomProject>(target, 'TomProject');
        final workspaceCrossCompilation = D4.getOptionalNamedArg<$tom_build_1.CrossCompilation?>(named, 'workspaceCrossCompilation');
        final workspaceModeDefinitions = D4.coerceMapOrNull<String, $tom_build_1.ModeDefinitions>(named['workspaceModeDefinitions'], 'workspaceModeDefinitions');
        final workspaceActions = D4.coerceMapOrNull<String, $tom_build_1.ActionDef>(named['workspaceActions'], 'workspaceActions');
