/// Markdown to LaTeX Converter CLI entry point.
library;
...
/// Main entry point for md_latex_converter CLI.
Future<void> mdLatexMain(List<String> arguments) async {
...
Examples:
  ...
  md2latex README.md --pdf

  # Convert to specific output directory
  md2latex README.md -o=output/

  # Convert to PDF and delete .tex file
  md2latex README.md --pdf --no-tex

  # Convert with custom document class
  md2latex README.md --document-class=report

  # Convert with deep TOC (all heading levels)
  md2latex README.md --toc-depth=5
