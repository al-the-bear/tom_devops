...
/// Command-line tool to convert Markdown files to PDF.
///
/// Usage:
/// ```
/// dart run tom_build_cli:md_pdf_converter <input> [options]
/// dart run tom_build_cli:md_pdf_converter docs/README.md
/// dart run tom_build_cli:md_pdf_converter docs/README.md -o output/
/// ```
Future<void> main(List<String> arguments) async {
  ...
  final tagStyle = HtmlTagStyle(
    ...
    // Remove any first-line indent by setting paragraph margin explicitly
...
Examples:
  ...
  dart run tom_build_cli:md_pdf_converter README.md

  # Convert to specific output directory
  dart run tom_build_cli:md_pdf_converter README.md -o=output/

  # Convert with custom options
  dart run tom_build_cli:md_pdf_converter README.md --format=letter --author="John Doe"

  # Convert with page numbers
  dart run tom_build_cli:md_pdf_converter README.md --page-numbers

  # Convert entire directory
  dart run tom_build_cli:md_pdf_converter docs/
''');
}
