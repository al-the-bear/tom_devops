...
/// Usage:
/// ```
/// dart run tom_build_cli:md_latex_converter <input> [options]
/// dart run tom_build_cli:md_latex_converter docs/README.md
/// dart run tom_build_cli:md_latex_converter docs/README.md --pdf
/// dart run tom_build_cli:md_latex_converter docs/README.md -o output/
/// ```
...
Examples:
  ...
  dart run tom_build_cli:md_latex_converter README.md

  # Convert to PDF (same folder as input)
  dart run tom_build_cli:md_latex_converter README.md --pdf

  # Convert to specific output directory
  dart run tom_build_cli:md_latex_converter README.md -o=output/

  # Convert to PDF and delete .tex file
  dart run tom_build_cli:md_latex_converter README.md --pdf --no-tex

  # Convert with custom document class
  dart run tom_build_cli:md_latex_converter README.md --document-class=report

  # Convert with deep TOC (all heading levels)
  dart run tom_build_cli:md_latex_converter README.md --toc-depth=5
