...
/// dart run tom_md2pdf:md2pdf docs/README.md
/// dart run tom_md2pdf:md2pdf docs/README.md -o output/
/// ```
...
Examples:
  ...
  dart run tom_md2pdf:md2pdf README.md -o=output/

  # Convert with custom options
  dart run tom_md2pdf:md2pdf README.md --format=letter --author="John Doe"

  # Convert with page numbers
  dart run tom_md2pdf:md2pdf README.md --page-numbers

  # Convert entire directory
  dart run tom_md2pdf:md2pdf docs/
''');
}
